    ...
    <div className="h-full bg-white flex justify-center">
      <div className="w-full max-w-[430px] p-6 box-border">
        ...
        <form onSubmit={handleSubmit} className="mt-7 flex flex-col gap-4">
          ...
          <button type="submit" disabled={loading} className="bg-green-500 text-white py-3 rounded-xl font-bold text-base">
            {loading ? '로딩중...' : '로그인'}
          </button>
          ...
          <div className="text-center text-gray-500">
            계정이 없나요? <Link to="/signup" className="text-green-600">회원가입하기</Link>
          </div>

          <div className="text-center text-gray-700 mt-2">SNS로 시작해보세요 !</div>

          <button type="button" className="bg-[#FEE500] border-0 py-3 rounded-xl font-bold">카카오로 시작하기</button>
          <button type="button" className="bg-white border-2 border-gray-200 py-3 rounded-xl font-bold">구글로 시작하기</button>
        </form>
